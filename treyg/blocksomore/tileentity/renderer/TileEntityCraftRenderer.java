...
public class TileEntityCraftRenderer extends TileEntitySpecialRenderer
{
	...
	public TileEntityCraftRenderer()
	{
		model = new ModelCraftingTable();
	}
	
	public void renderAModelAt(TileEntityCraft tile, double d, double d1, double d2, float f)
	{
		...
		{
		case 0:
			Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation("textures/blocks/blocksomore/textures/blocks/craftTable.png"));
			break;
		default:
			Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation("textures/blocks/blocksomore/textures/blocks/craftTable.png"));
		}
	...
	{
		renderAModelAt((TileEntityCraft) tileentity, d, d1, d2, f); //where to render
	}
