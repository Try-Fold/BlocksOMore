...
import treyg.blocksomore.render.models.ModelCandleStick;
import treyg.blocksomore.tileentity.TileEntityCandleStick;

public class TileEntityCandleStickRenderer extends TileEntitySpecialRenderer
{
	private ModelCandleStick model;
	
	public Minecraft mc = Minecraft.getMinecraft();
	
	public TileEntityCandleStickRenderer()
	{
		model = new ModelCandleStick();
	}
	
	public void renderAModelAt(TileEntityCandleStick tile, double d, double d1, double d2, float f)
	{
		...
		{
		case 0:
			Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation("textures/blocks/blocksomore/textures/blocks/candleStick.png"));
			break;
		default:
			Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation("textures/blocks/blocksomore/textures/blocks/candleStick.png"));
		}
	...
	{
		renderAModelAt((TileEntityCandleStick) tileentity, d, d1, d2, f); //where to render
	}
