...
public class TileEntityCandleThickRenderer extends TileEntitySpecialRenderer
{
	...
	public TileEntityCandleThickRenderer()
	{
		model = new ModelCandleThick();
	}
	
	public void renderAModelAt(TileEntityCandleThick tile, double d, double d1, double d2, float f)
	{
		...
		{
		case 0:
			Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation("textures/blocks/blocksomore/textures/blocks/candleThick.png"));
			break;
		default:
			Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation("textures/blocks/blocksomore/textures/blocks/candleThick.png"));
		}
	...
	{
		renderAModelAt((TileEntityCandleThick) tileentity, d, d1, d2, f); //where to render
	}
